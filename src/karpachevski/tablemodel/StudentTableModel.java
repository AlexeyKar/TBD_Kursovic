	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		try {
			...
			switch (columnIndex) {
				...
				case 3: return entity.getDateOfAdmission().get(Calendar.DAY_OF_MONTH) + "."
						+ entity.getDateOfAdmission().get(Calendar.MONTH) + "."
						+ entity.getDateOfAdmission().get(Calendar.YEAR);
				case 4: return entity.getDateOfPlanDiss().get(Calendar.DAY_OF_MONTH) + "."
						+ entity.getDateOfPlanDiss().get(Calendar.MONTH) + "."
						+ entity.getDateOfPlanDiss().get(Calendar.YEAR);
				case 5: return entity.getDateOfFactDiss().get(Calendar.DAY_OF_MONTH) + "."
